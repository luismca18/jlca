...
SELECT `demandaidexpediente` as idExped,  `demandaaudienciasidaudiencias` as idAudi, `demandaaudienciasnumexpediente` as numExped, `demandaaudienciasfecpresentaci` as fecPresenta,
  ...
  `demandaaudienciastipoaudiencia` as tipoAudi, `demandaaudienciasidjunta` as idJunta, `demandaaudienciasidsecretaria` as idsecre
FROM `demandaaudiencias` where `demandaaudienciasnumexpediente`= $numExped `demandaaudienciasidjunta` = $idJunta

-- --------------------------------------------------------

SELECT  
  `demandaidexpediente` as idExped, `demandadocumentoinicialidjunta` as idJunta, `demandadocumentoinicialidsecretaria` as idSecre, `demandadocumentoinicialiddocum` as idRadica,
  ...
  `demandadocumentoinicialnompres` as nomPresento, `demandadocumentoinicialestado` as estado
FROM `demandadocumentoinicial` where  `demandadocumentoinicialnumexpe`= $numExped `demandadocumentoinicialidjunta`= $idJunta

-- --------------------------------------------------------

SELECT  
  `demandaidexpediente` as idExped,  `demandalaudosidlaudos` as idLaudo, `demandalaudosfecpresentacion` as fecPresenta, `demandalaudoshorapresentacion` as horPresenta, 
  ...
  `demandalaudosidacumulado`   as idAcum, `demandalaudosnumexpediente` as numExped
FROM `demandalaudos` where `demandalaudosnumexpediente`= $numExped `demandalaudosidjunta`= $idJunta

-- --------------------------------------------------------

SELECT  
  `demandaidexpediente` as idExped,  `demandanotificacionidnotificac` as idNotifica, `demandanotificacionidjunta` as idJunta,  `demandanotificacionidsecretaria` as idSecre,
...
SELECT  
  `demandaidexpediente` as idExped, `demandaoficiosidoficios` as idOficio, `demandaoficiosnumexpediente` as numExped, `demandaoficiosturnado` as turnado,
  ...
  `demandaoficiosestado` as estado, `demandaoficiosidacumulado` as idAcum, `demandaoficiosidjunta` as idJunta, `demandaoficiosidsecretaria` as idSecre
FROM `demandaoficios` where  `demandaoficiosnumexpediente`= $numExped `demandaoficiosidjunta`= $idJunta

SELECT  
  `demandaidexpediente` as idExped, `demandapromocionesidpromocione` as idPromo, `demandapromocionesnumexpedient` as numExped, `demandapromocionesturnado` as turnado,
  ...
  `demandapromocionesimprocedente` as improce, `demandapromocionesidjunta` as idJunta,  `demandapromocionesidsecretaria` as idSecre
FROM `demandapromociones` where  `demandapromocionesnumexpedient`= $numExped `demandapromocionesidjunta` = $idJunta
-- --------------------------------------------------------
...
SELECT `demandaidexpediente` AS idExped, `demandaresolucionesidresolucio` as idReso, `demandaresolucionesnumexpedien` as numExped, `demandaresolucionesturnado` as turnado,
  ...
  `demandaresolucionesidacumulado` as idAcum, `demandaresolucionesidjunta` as idJunta, `demandaresolucionesidsecretaria` as idSecre
FROM `demandaresoluciones`where `demandaresolucionesnumexpedien`= $numExped `demandaresolucionesidjunta`= $idJunta
...
SELECT `demandaidexpediente` as idExped, `demandavistosidvistos` as idVisto, `demandavistosnumexpediente` as numExped, `demandavistosturnado` as turnado,
  ...
  `demandavistosestado` as estado, `demandavistosidacumulado` as idAcum, `demandavistosidjunta` as idJunta, `demandavistosidsecretaria` as idsecre
  FROM `demandavistos` where `demandavistosnumexpediente` = $numExped `demandavistosidjunta` = $idJunta